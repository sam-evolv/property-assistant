...
export function PreHandoverHome({ data, onOpenSheet }: Props) {
  return (
    <div className="min-h-screen pb-20">
      <header className="px-4 pt-[calc(12px+env(safe-area-inset-top))] pb-2 flex items-center justify-between animate-[fadeIn_0.3s_ease-out]">
        <div>
        ...
        <button
          ...
          className="group w-9 h-9 rounded-lg bg-white/90 backdrop-blur-xl border border-white/90 flex items-center justify-center active:scale-95 transition-all duration-200 shadow-[0_2px_8px_rgba(12,12,12,0.04)] hover:border-[#D4AF37]/20"
        >
      ...
      <main className="px-4 space-y-3">
        ...
        <div className="rounded-2xl bg-gradient-to-br from-[#0F0F0F] to-[#1A1A0A] p-4 text-white shadow-[0_8px_24px_rgba(0,0,0,0.12)] animate-[slideUp_0.5s_cubic-bezier(0.2,0.8,0.2,1)]"

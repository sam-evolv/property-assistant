...
type TeamRole = 'installer' | 'support' | 'admin' | 'field-engineer';
...
const mockTeamMembers: TeamMember[] = [
  { id: '1', name: 'Declan Brennan', email: 'd.brennan@careenergy.ie', role: 'admin', status: 'online', lastActive: new Date(), messagesHandled: 156 },
  { id: '2', name: 'Niamh Gallagher', email: 'n.gallagher@careenergy.ie', role: 'installer', status: 'online', lastActive: new Date(), messagesHandled: 89 },
  { id: '3', name: 'Cormac Healy', email: 'c.healy@careenergy.ie', role: 'support', status: 'away', lastActive: new Date(Date.now() - 30 * 60 * 1000), messagesHandled: 203 },
  { id: '4', name: 'Aoife Nolan', email: 'a.nolan@careenergy.ie', role: 'installer', status: 'offline', lastActive: new Date(Date.now() - 2 * 60 * 60 * 1000), messagesHandled: 67 },
  { id: '5', name: 'Ronan Fitzpatrick', email: 'r.fitzpatrick@careenergy.ie', role: 'field-engineer', status: 'offline', lastActive: new Date(Date.now() - 24 * 60 * 60 * 1000), messagesHandled: 12 },
];

const mockTemplates: MessageTemplate[] = [
  { id: '1', name: 'Maintenance Reminder', subject: 'Scheduled Maintenance for Your System', content: 'Dear [Name], Your [System] is due for its scheduled maintenance on [Date]...', type: 'email', category: 'Maintenance', usageCount: 45, lastUsed: new Date() },
  { id: '2', name: 'Warranty Expiry Notice', subject: 'Action Required: Warranty Expiring Soon', content: 'Hi [Name], Your warranty for the [System] installed at [Installation] is expiring soon...', type: 'email', category: 'Warranty', usageCount: 28, lastUsed: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000) },
  { id: '3', name: 'Seasonal Performance Tips', subject: 'Get the Most From Your System This Season', content: 'Dear [Name], As the seasons change, here are some tips to optimise your [System]...', type: 'email', category: 'Performance', usageCount: 67, lastUsed: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000) },
  { id: '4', name: 'SEAI Grant Update', subject: 'New SEAI Grant Information Available', content: 'Hi [Name], There are new SEAI grant updates that may apply to your [Installation]...', type: 'email', category: 'Grants', usageCount: 112, lastUsed: new Date() },
  { id: '5', name: 'Annual Service Due', subject: 'Your Annual Service is Due', content: 'Dear [Name], Your annual service for the [System] at [Installation] is now due...', type: 'email', category: 'Service', usageCount: 23 },
];

const mockCommunicationLogs: CommunicationLog[] = [
  { id: '1', recipient: 'M. Doyle', recipientEmail: 'm.doyle@email.com', subject: 'Maintenance Reminder', type: 'email', status: 'delivered', sentAt: new Date(Date.now() - 2 * 60 * 60 * 1000), sentBy: 'Declan Brennan', openRate: 100 },
  { id: '2', recipient: 'K. Flynn', recipientEmail: 'k.flynn@email.com', subject: 'Warranty Expiry Notice', type: 'email', status: 'delivered', sentAt: new Date(Date.now() - 4 * 60 * 60 * 1000), sentBy: 'Niamh Gallagher', openRate: 100, clickRate: 50 },
  { id: '3', recipient: 'T. Maguire', recipientEmail: 't.maguire@email.com', subject: 'SEAI Grant Update', type: 'email', status: 'sent', sentAt: new Date(Date.now() - 1 * 60 * 60 * 1000), sentBy: 'System' },
  { id: '4', recipient: 'All Customers (Heat Pump)', recipientEmail: 'bulk', subject: 'Seasonal Performance Tips', type: 'email', status: 'scheduled', scheduledFor: new Date(Date.now() + 24 * 60 * 60 * 1000), sentBy: 'Declan Brennan' },
  { id: '5', recipient: 'S. Kavanagh', recipientEmail: 's.kavanagh@email.com', subject: 'Annual Service Due', type: 'email', status: 'failed', sentAt: new Date(Date.now() - 30 * 60 * 1000), sentBy: 'Cormac Healy' },
];
...
const roleConfig: Record<TeamRole, { label: string; color: string; bgColor: string }> = {
  ...
  installer: { label: 'Installer', color: 'text-blue-600', bgColor: 'bg-blue-50' },
  support: { label: 'Support', color: 'text-green-600', bgColor: 'bg-green-50' },
  'field-engineer': { label: 'Field Engineer', color: 'text-amber-600', bgColor: 'bg-amber-50' },
};
...
export default function CareCommunicationsHubPage() {
      ...
      <div className="p-6 lg:p-8">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-start justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Care Communications Hub</h1>
              <p className="text-sm text-gray-500 mt-1">
                Manage installer communications and customer messaging
              </p>
            </div>
            <div className="flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <button className="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors text-left">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Message multiple customers</p>
                      </div>
                    </button>
                  </div>
                </div>
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex flex-wrap gap-2">
              {['[Name]', '[System]', '[Installation]', '[Date]', '[Link]'].map((v) => (
                <button
                  key={v}

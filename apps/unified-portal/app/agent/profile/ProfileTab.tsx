...
const integrations: { name: string; connected: boolean }[] = [
  { name: 'Daft.ie', connected: true },
  { name: 'MyHome.ie', connected: true },
        ...
        <div style={{ ...card, padding: 20, marginBottom: 20 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              ...
              <div style={{ color: T3, fontSize: 12, marginTop: 1 }}>Sherry FitzGerald Cork</div>
              <div style={{ color: GOLD, fontSize: 11, fontWeight: 600, marginTop: 2 }}>Senior Sales Agent</div>
            </div>
          </div>
          ...
          >
            {stats.map((s, i) => (
              ...
              >
                ...
                <div style={{ color: T3, fontSize: 10, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', marginTop: 2 }}>{s.l}</div>
              </div>
            ))}
          </div>
        </div>

...
export function UnitImport({ developmentId, developmentName, tenantId, spreadsheetUrl, onImportComplete }: UnitImportProps) {
  ...
  // Generate unique access code for a unit
  ...
  // Get development prefix (first 3 chars of each word)
  ...
  const handleImport = async () => {
    ...
    for (let i = 0; i < parsedData.length; i++) {
      ...
      try {
        ...
        // If no address, construct from unit number

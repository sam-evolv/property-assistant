...
export const unit_room_dimensions = pgTable('unit_room_dimensions', {
  ...
  tenant_id: uuid('tenant_id').references(() => tenants.id).notNull(),
  development_id: uuid('development_id').references(() => developments.id).notNull(),
  house_type_id: uuid('house_type_id').references(() => houseTypes.id).notNull(),
  unit_type_code: text('unit_type_code').notNull(),
  room_name: text('room_name').notNull(),
  canonical_room_name: text('canonical_room_name').notNull(),
  level: text('level'),
  ...
  tenantDevHouseTypeIdx: index('room_dims_tenant_dev_house_type_idx').on(table.tenant_id, table.development_id, table.house_type_id, table.unit_type_code),
  tenantHouseTypeRoomIdx: index('room_dims_tenant_house_type_room_idx').on(table.tenant_id, table.house_type_id, table.room_name),
  canonicalRoomIdx: index('room_dims_canonical_room_idx').on(table.tenant_id, table.house_type_id, table.canonical_room_name),
}));
